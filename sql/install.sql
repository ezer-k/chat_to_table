-- Idempotent WorldTable application installation.
-- This file is executed directly from the Snowflake Git repository clone.
...
GRANT USAGE ON SCHEMA WORLDTABLE.RESULTS TO ROLE ACCOUNTADMIN;
...
CREATE OR REPLACE STREAMLIT WORLDTABLE.APP.WORLDTABLE_APP
  FROM @WORLDTABLE.APP.SOURCE/branches/main/
  MAIN_FILE = 'streamlit_app.py'
  QUERY_WAREHOUSE = WORLDTABLE_WH
  RUNTIME_NAME = 'SYSTEM$ST_CONTAINER_RUNTIME_PY3_11'
  COMPUTE_POOL = SYSTEM_COMPUTE_POOL_CPU
  TITLE = 'WorldTable';

ALTER STREAMLIT WORLDTABLE.APP.WORLDTABLE_APP
  ADD LIVE VERSION FROM LAST;

GRANT USAGE ON STREAMLIT WORLDTABLE.APP.WORLDTABLE_APP TO ROLE ACCOUNTADMIN;
